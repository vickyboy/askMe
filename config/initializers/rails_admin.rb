## RailsAdmin config file. Generated on July 05, 2013 18:43
...
#  config.main_app_name = ['Ask Me', 'Admin']
...
#  # config.excluded_models = ['Admin', 'Answer', 'Question', 'Role', 'User']
#
#  # Include specific models (exclude the others):
#  # config.included_models = ['Admin', 'Answer', 'Question', 'Role', 'User']
#
